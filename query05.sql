/* 
  Rate neighborhoods by their bus stop accessibility for 
  wheelchairs. Use Azavea's neighborhood dataset from 
  OpenDataPhilly along with an appropriate dataset from 
  the Septa GTFS bus feed. Use the GTFS documentation for 
  help. Use some creativity in the metric you devise in 
...
create index if not exists neighborhoods_philadelphia_geometry_32129__idx
...
-- query the percentage of stops with wheelchair boardings to rate accessibility for wheelchairs
select 
